...
The canonical profiling workload is the headless Release build: `bin\Release\goblin-stream.exe --headless`
...
3. **Build Release binary** — via agent-wrap.ps1 with 300 s timeout:
   ```powershell
