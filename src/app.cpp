...
void App::RecordCommandList(ID3D12GraphicsCommandList* command_list,
...
bool App::ProcessWindowMessages(MSG& msg) {
...
App::FrameWaitResult App::WaitForFrame(FrameDebugLog& frame_debug_log, HANDLE* fence_handles,
...
bool App::IsFrameReady(const std::vector<FrameResources>& frames, uint32_t back_buffer_index,
...
void App::LogFenceStatus(FrameDebugLog& frame_debug_log, uint64_t completed_value,
...
void App::ExecuteFrame(ID3D12CommandQueue* command_queue, FrameResources& frame_resources,
					   HRESULT present_result) {
...
HRESULT App::PresentAndSignal(ID3D12CommandQueue* command_queue, IDXGISwapChain4* swap_chain,
...
bool App::HandlePresentResult(FrameDebugLog& frame_debug_log, HRESULT present_result) {
...
void App::LogFrameSubmitted(FrameDebugLog& frame_debug_log, uint32_t back_buffer_index,
