...
D3D12Device::D3D12Device(bool use_warp) {
	create_device(use_warp);
...
void D3D12Device::create_device(bool use_warp) {
	...
	if (use_warp) {
		...
		Try | factory->EnumAdapterByGpuPreference(0, DXGI_GPU_PREFERENCE_HIGH_PERFORMANCE,
